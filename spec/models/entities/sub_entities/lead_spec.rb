  ...
  context "Instance Methods" do
    ...
    describe '#map_to connec! Person' do
      ...
      let(:mapped_external_hash) {
        {
          :id => [{"id"=>1903091207, "provider"=>"this_app", "realm"=>organization.oauth_uid}],
          :assignee_id => [{"id"=>960788, "provider"=>"this_app", "realm"=>organization.oauth_uid}],
          :first_name => "John",
          :last_name => "Lead",
          :job_title => "CTO",
          :email => {
    ...
    describe '#map_to connec! Organization' do
      ...
      let(:mapped_external_hash) {
        {
          :id => [{"id"=>1903091859, "provider"=>"this_app", "realm"=>organization.oauth_uid}],
          :assignee_id => [{"id"=>960788, "provider"=>"this_app", "realm"=>organization.oauth_uid}],
          :name => "Company Lead",
          :industry => "ITC",
          :email => {
